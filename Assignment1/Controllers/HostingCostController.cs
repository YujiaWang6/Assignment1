...
namespace Assignment1.Controllers
{
    public class HostingCostController : ApiController
    {
        ...
        /// <explanition> The input number will be the total days. As $5.5/FN (fortnight = 14 days), the fortnight number should be calculated based on the total days.
        ...
        /// </returns>
        /// <example>
        /// GET: api/HostingCost/0  -->  1 fortnights at $5.50/FN = $5.5 CAD
        ///                              HST 13% = $0.72 CAD
        ///                              Total = $6.22 CAD
        /// </example>
        /// <example>
        /// GET: api/HostingCost/14  --> 2 fortnights at $5.50/FN = $11 CAD
        ///                              HST 13% = $1.43 CAD
        ///                              Total = $12.43 CAD
        /// </example>
        /// <example>
        /// GET: api/HostingCost/15  --> 2 fortnights at $5.50/FN = $11 CAD
        ///                              HST 13% = $1.43 CAD
        ///                              Total = $12.43 CAD                          
        /// </example>
        /// <example>
        /// GET: api/HostingCost/21  --> 2 fortnights at $5.50/FN = $11 CAD
        ///                              HST 13% = $1.43 CAD
        ///                              Total = $12.43 CAD
        /// </example>
        /// <example>
        /// GET: api/HostingCost/28  --> 3 fortnights at $5.50/FN = $16.5 CAD
        ///                              HST 13% = $2.14 CAD
        ///                              Total = $18.64 CAD
        /// </example>
        public IEnumerable<string> Get(decimal id)
        {
            ...
            feeBeforeTax = (double)System.Math.Round(feeBeforeTax, 2);

            double tax = (feeBeforeTax * 0.13);

            tax = (double)System.Math.Round(tax, 2);
            ...
            string feeBeforeTaxString = feeBeforeTax.ToString();

            string taxString = tax.ToString();

            string totalFeeString = totalFee.ToString();
